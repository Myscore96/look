        ...
        <div class="d-flex flex-column" style="margin-left: 13%;padding-top: 2%;width: 70%">
            ...
            <div class="personal_block">
                    ...
                    <div class="div_button" style="margin-top: 4%;padding-left: 1%;margin-bottom: 3%">
                        <button style="font-size: 20px;font-weight: 500;display: none"id="canselschool" >@lang('personal_data.Cancel') </button>
                        <button ></button>
                        <button class="button button_right" name="school"  onclick="show(name,this)">@lang('personal_data.edit')</button>
                        <button class="button button_right" id="saveschool" style="display: none" >@lang('personal_data.save')</button>
                    </div>
            </div>
            <div class="personal_block">
                    ...
                    <div class="div_button" style="margin-top: 4%;padding-left: 1%;margin-bottom: 3%">
                        <button style="font-size: 20px;font-weight: 500;display: none" id="canselprofesion">@lang('personal_data.Cancel')</button>
                        <button></button>
                        <button class="button button_right" style="display: none" id="saveprofesion">@lang('personal_data.save')</button>
                        <button class="button button_right" name="profession"  onclick="show(name,this)">@lang('personal_data.edit')</button>
                    </div>
            </div>
            <div class="personal_block">
                ...
                <div class="div_button" style="margin-top: 4%;padding-left: 1%;margin-bottom: 3%">
                    <button style="font-size: 20px;font-weight: 500;display: none" id="clean" onclick="Cansel()" >@lang('personal_data.Cancel')</button>
                    <button></button>
                    <button class="button button_right" id="button_lang" name="languages">@lang('personal_data.edit')</button>
                    <button class="button button_right"  style="display: none" id="languagessave" onclick="Save()">@lang('personal_data.save')</button>
                </div>
